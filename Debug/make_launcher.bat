...
#   i.e.   ${workspace_loc:SWatch_Simulink_NewInterface}/make_launcher.bat


ERIKA_FILES=/Users/Andrea/Desktop/eclipse/plugins/com.eu.evidence.ee_2.6.0.20151106_2005/ee_files
export ERIKA_FILES
